...
" y no utiliza comillas; a los constructores se les debe de pasar como parametro
...
| - operador 'OR', la espreción regular x|y coincidirá con x o con y.

[] - los corchetes se usan para definir clases de caracteres, por ejemplo: la
espresión regular /g[uo]n/ coincidirá solamente con 'gun' y con 'gon'

[-] - dentro de los corchetes se pueden poner rangos de caracteres, por
ejemplo: /b[a-z]l/

[^] - el simbolo de exoponente al principio del rango de caracteres es un
...
repetición que será encerrado en el parentesis, por ejemplo:
...
+ - el símbolo de suma sirve para determinar si un caracter o conjunto de 
caracteres aparecen una o más veces de manera susesiva, por ejemplo en el texto 
'Sisssess', la expresión regular /s+/g coincidiría en dos puntos ['sss', 'ss']

* - el símbolo de multiplicación determina si un caracter o conjunto de
caracteres aparecen 0 más veces de manera susesiva, similar al utilizar '+',
...
^ - el símbolo de exponente fuera de los corcetes se utiliza para que una
expresión regular concida con el patrón unicamente si este está al inicio del
texto, por ejemplo: /^call/ coincidirá en el texto 'call me' pero no con el
texto 'he called me'.

$ - similar al simbolo de exponente cuando está fuera de corcetes, el símbolo
...
x(?=y) - conocida como acerción anticipada, esta notación regresará 'x' solo
si a 'x' le sigue 'y'

x(?!y) - conocida como acerción anticipada negativa, tiene el mísmo efecto
...
(?<!y)x - conocida como aserción retorspectiva negativa, esta notación hace una
coincidencia con 'x' solo si no le precede 'y' 


" Clases de caracteres

. - el punto o comodin se explica mejor con un ejemplo: /.un/ va a coincidir
...
\d - es una abreviatura que coincide con todos los números, es equivalete
a [0-9]

\D - es el opuesto del atajo anterior, es equivalente a [^0-9]

\s - es una abreviatura que coincide con todos los espcions en blanco, es
equivalente a [ \r\t\f\n\v]
